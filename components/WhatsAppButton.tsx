...
/**
 * The official WhatsApp glyph. Inlined rather than imported because Lucide
 * carries no brand icons — its `MessageCircle` is a generic speech bubble that
 * reads as "chat", not as WhatsApp.
 */
